...
//f est une liste à n éléments allant de - T / 2 à T / 2 (2k - n) / nT / 2
// la plage de valeur en sortie, b, est reliée à T par la relation b*T=2*PI*n
{
...
//f est une liste à n éléments allant de -a/2 à a/2 (2k-n)/na/2 et renvoie une liste d'éléments correspondant aux valeurs de la transformée de Fourier de f allant de -b/2 à b/2
{
	vector<NombreComplexe> M;
	vector<NombreComplexe> f = m_signal_ralonge;
